...
/*
Parametrar:
ServiceArea_p           Service Area
MaxDate_p               Normalt aktuellt datum
MinDate_p               Optionellt min datum
FilePath_p              Sökväg till DB
DBQuery_p               DB query
...
2021-08-31    tswm00    Rättar. MinDate är optional. MaxDate skall normalt vara aktuellt datum
*/
// =======================================================================
...
///*
    ...
    (
        ...
        MinDate_p       as  nullable    datetime,
        MaxDate_p       as              datetime,
        FilePath_p      as              text,
        DBQuery_p       as              text
    ) 
    as table =>
