let
// =================================================================================================================================
// fnReturnSPfileODataFeedV3
// Retrives a full path and modified date as a table to a SharePoint file possible to read with a Web.Contents() request
// ---------------------------------------------------------------------------------------------------------------------------------
/*
2018-06-21    tswm00    New function
2020-10-02    tswm00    Correct pathhandling
2020-12-17    tswm00    Returns a table with FileName and ModifiedDate as table. Not backward compatible
*/
// =================================================================================================================================
// External references
// =================================================================================================================================
...
///*
    fnReturnSPfileODataFeed =                   // Retrives a full path to a SharePoint file possible to read with a Web.Contents() request
        ...
        optional SharePointNewest_p     as nullable logical    // Retrive newest file if true or omitted, oldest if false
        )
    as table =>
...
// ---------------------------------------------------------------------------------------------------------------------------------
        ...
        SharePointFolder_p               = "/Ekonomi/Tele2/",
        SharePointAlternateFolder_p      = null,
        SharePointFilenameContains_p     = "subscriptionAccounts.xml",
...
// ---------------------------------------------------------------------------------------------------------------------------------
    ModifiedDate = DateTime.From(KeptFirstRows[Modified]{0}),
    FileName = SharePointBaseURL & Text.TrimStart(SharePointFolder,"/") & Record.Field(KeptFirstRows{0},"Name"),

    Result = Table.FromRecords({[FileName = FileName, ModifiedDate = ModifiedDate]},type table[FileName = Text.Type, ModifiedDate = DateTime.Type])
