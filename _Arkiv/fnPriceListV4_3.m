...
//*/
        ...
        SortedRows = Table.Sort(ExpandPriceList,{{"PriceList.CA-Description", Order.Ascending}, {"PriceList.CSA-Description", Order.Ascending}, {"PriceList.StCM-Denomination", Order.Ascending}}),

        fnPriceListPriceListValid = Table.AddColumn(SortedRows, "fnPriceList.PriceListValid", each [#"PriceList.StCM-Denomination"] <> null, type logical),
