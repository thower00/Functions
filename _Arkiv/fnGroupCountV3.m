...
//*/
        ...
        // Skapa reorderlist med CountColName först
        ReorderList = List.InsertRange(AllColumnNamesList, 0, CountColNameList),
        ...
        Expand = Table.ExpandTableColumn(AddIndex, "AllRows", ExpandColumnNamesList),
