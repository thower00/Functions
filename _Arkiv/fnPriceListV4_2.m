...
UseCase3:
-----------------------------------------------------------------------------
Ingen indatatabell. Vill ha ut mappning från specifika begrepp genom att referens till qSpecificComponentModel skickas med som indataparameter.
islistan från databasen enligt angivna parametrar (Date, DateMin, DateMax)
...
//    6: qSpecificComponent skickas med som text referens
...
//*/
        ...
        let
            ...
            if Date <> null then
                ...
                SelectServiceArea,
            RenameDate = Table.RenameColumns(SelectWithinInterval,{{"ValidFromDate", "MapFromDate"}, {"ValidToDate", "MapToDate"}})
        in
            RenameDate,
